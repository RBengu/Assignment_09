...
class Track():
    ...
    """
    # -- Constructor -- #
    def __init__(self, track_pos, track_title, track_length):
        try:
    ...
    def __str__(self):
        ...
        return '{:>2}.\t{} ({})'.format(self.track_pos, self.track_title, self.track_length)

    def get_record(self) -> str:
        """Returns: Track record formatted for saving to file"""
        return '{},{},{}\n'.format(self.track_pos, self.track_title, self.track_length)
